      ...
      <div className='flex flex-col md:flex-row w-full justify-between items-center'>
        <div className='w-full md:w-1/2 flex justify-center items-center px-4'>
          <div>
            ...
            <p className=' text-sm text-start text-slate-300 w-5/6 md:w-2/3 py-8'>We&apos;re here to help! Feel free to reach out to us, and we&apos;ll get back to you via email. <br />Whether you have a question, feedback, or just want to say hello, don&apos;t hesitate to contact us!</p>
