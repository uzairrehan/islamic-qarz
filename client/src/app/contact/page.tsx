      ...
      <div className="flex flex-col md:flex-row w-full justify-between items-center">
        <div className="w-full md:w-1/2 flex justify-center items-center px-4">
          <div>
            ...
            <p className=" text-sm text-start text-slate-300 w-5/6 md:w-2/3 py-8">
              We&apos;re here to help! Feel free to reach out to us, and
              we&apos;ll get back to you via email. <br />
        ...
        <div className="flex justify-center items-center flex-col gap-4 w-full md:w-1/2">
          <div className="md:w-3/4 w-full">
            <h1 className="text-2xl md:text-3xl pt-16 font-bold w-full p-4 md:pl-0">
              Contact Us.
            </h1>
            <form action="" className="w-full md:p-0 p-4 ">
              <label htmlFor="name">
                ...
                <input
                  type="text"
                  id="name"
                  className=" w-full rounded-lg h-8 mb-4 text-black"
                />
              </label>
              <label htmlFor="email">
              ...
              <label htmlFor="query">
                ...
                <textarea
                  id="query"
                  className=" w-full rounded-lg h-28 mb-4 text-black"
                />
              </label>
              <button
                type="button"
