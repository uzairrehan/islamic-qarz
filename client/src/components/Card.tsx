        ...
        <>
            <div className='rounded-lg bg-transparent flex justify-center items-center flex-col mx-3 relative'>
                <div className="relative group">
                    <div className="absolute inset-0 bg-gradient-to-t from-[#071629]/100 hover:z-10 transition-opacity duration-300 ease-in-out opacity-0 group-hover:opacity-100" />
                    <Image
                        src={img}
                        alt={name}
                        width={400}
